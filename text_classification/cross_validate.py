...
def cross_validate_2(inputs, labels, chunk_size, hidden_layer_size):
...
def cross_validate_input():
    ...
    hidden_layer_size = [(i, i, i) for i in [50, 60, 70, 80, 90]]
    ...
    with open(err_file, 'w') as f:
        for hidden_layer in hidden_layer_size:
            ...
            mean_err, sd_err = cross_validate_2(training_data, labels, chunk_size, hidden_layer)
